...
export const TechCard = ({ children, className, variant: _variant = 'default', ...props }: TechCardProps) => {
  return (
    <div
      className={cn(
        'relative group',
    ...
    >
      ...
      <div 
        className="absolute bottom-[-1px] right-[19px] w-[28px] h-[2px] bg-cyan-500/50 z-10 origin-right rotate-[-45deg]" 
      />
