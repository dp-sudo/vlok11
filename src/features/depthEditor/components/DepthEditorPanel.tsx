...
export const DepthEditorPanel = memo<DepthEditorPanelProps>(({ depthImageUrl, onClose, onApply }) => {
      ...
      <div className="bg-zinc-900 rounded-xl shadow-2xl border border-zinc-700 w-full max-w-4xl h-[80vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="flex-1 flex flex-col p-4 gap-4">
            <DepthEditorToolbar currentTool={editor.currentTool} onToolChange={editor.setCurrentTool} />
            <DepthEditorCanvas
